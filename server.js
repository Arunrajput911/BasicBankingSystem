...
mongoose.connect('mongodb://localhost:27017/bankingSystem',{useNewUrlParser:true,useCreateIndex:true,useUnifiedTopology:true})
...
// update all
// Account.updateMany({},{$inc:{balance:1000}}, () => {}) 
